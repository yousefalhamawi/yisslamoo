      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-2xl bg-[#F6F1FA] border border-[#4C1D95]/10 px-6 py-5 text-[#4C1D95]">
            ...
            <div className="text-gray-600 text-sm md:text-base leading-8 font-normal space-y-4">
              <p>
                من هنا، وُلِد <strong className="text-[#4C1D95] font-black">"متجر يسلمو"</strong> – وجهتك للهدايا المختارة بعناية، حيث تجتمع اللمسة الشخصية والجودة العالية والتصميم الراقي.
              </p>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] border-[10px] border-white shadow-[0_28px_70px_rgba(46,16,101,0.16)] bg-white">
              ...
              />
              <div className="absolute inset-x-4 bottom-4 flex items-center justify-between rounded-2xl bg-[#4C1D95]/90 backdrop-blur-md px-4 py-3 text-white shadow-lg">
                <div>
