  ...
  return (
    <>
      ...
      >
        ...
        <button 
          onClick={() => navigate('/')}
          className={`flex flex-col items-center justify-center gap-1.5 flex-1 transition-colors duration-200 ${location.pathname === '/' ? 'text-[#4C1D95]' : 'text-gray-400 hover:text-gray-700'}`}
        >
          <House className={`w-6 h-6 stroke-[1.5] ${location.pathname === '/' ? 'fill-[#4C1D95]/10' : ''}`} />
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center gap-1.5 flex-1 transition-colors duration-200 ${location.pathname === '/shop' ? 'text-[#4C1D95]' : 'text-gray-400 hover:text-gray-700'}`}
        >
        ...
        >
          <div className="relative">
            ...
            {cartCount > 0 && (
              <span className="absolute -top-2 -right-2 min-w-[16px] h-4 bg-[#4C1D95] text-white text-[8px] font-black rounded-full flex items-center justify-center border-2 border-white px-1">
                {cartCount}
              </span>
            )}
          </div>
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center gap-1.5 flex-1 transition-colors duration-200 ${location.pathname === '/settings' ? 'text-[#4C1D95]' : 'text-gray-400 hover:text-gray-700'}`}
        >
